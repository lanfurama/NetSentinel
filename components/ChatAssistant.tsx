...
const ChatAssistant: React.FC<ChatAssistantProps> = ({ isOpen, onClose, devices, alerts, currentUser, initialContext }) => {
  ...
  return (
    <div className="fixed bottom-6 right-6 w-96 h-[600px] bg-slate-900 border border-slate-700 rounded-lg shadow-2xl flex flex-col z-50 animate-fade-in overflow-hidden">
      {/* Header */}
      ...
      <div className="p-4 bg-slate-900 border-t border-slate-800">
        <div className="flex gap-2">
          <input
            type="text"
            className="flex-1 bg-slate-800 border border-slate-700 rounded-md px-4 py-2 text-sm text-white focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent placeholder-slate-500"
          ...
          <button 
            ...
            className="p-2.5 bg-blue-600 hover:bg-blue-500 disabled:bg-slate-700 disabled:text-slate-500 text-white rounded-md transition-colors"
          >
